...
case class CreateBreakoutRoomMsg(meetingId: String, parentMeetingId: String,
                                 ...
                                 record: Boolean, captureNotes: Boolean, captureSlides: Boolean, captureNotesFilename: String, captureSlidesFilename: String,
                                 defaultNotesText: String) extends ApiMsg
